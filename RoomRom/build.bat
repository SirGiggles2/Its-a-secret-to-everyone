...
set "INCS=-I%PROJ%\src -I%SGDK%\inc -I%SGDK%\res -I%REPO%\src -I%REPO%\src\abi -I%REPO%\src\state -I%REPO%\src\game -I%REPO%\src\game\cave -I%REPO%\src\game\world -I%REPO%\src\game\core -I%REPO%\src\game\enemies -I%REPO%\src\game\combat -I%REPO%\src\game\room -I%REPO%\src\oracle\room"
