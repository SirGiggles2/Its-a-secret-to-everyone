...
set "INCS=-I%PROJ%\src -I%SGDK%\inc -I%SGDK%\res -I%REPO%\src -I%REPO%\src\abi -I%REPO%\src\state -I%REPO%\src\game -I%REPO%\src\game\cave -I%REPO%\src\game\world -I%REPO%\src\game\core -I%REPO%\src\game\enemies -I%REPO%\src\game\combat -I%REPO%\src\oracle\room"
...
rem ---------------------------------------------------------------------------
echo [4] Linking...
set "OBJS=%OUT%\nes_ram_init.o %OUT%\cave_dispatch.o %OUT%\world_dispatch.o %OUT%\object_dispatch.o %OUT%\sprite_dispatch.o %OUT%\progress_dispatch.o %OUT%\trap_dispatch.o %OUT%\core_dispatch.o %OUT%\enemy_dispatch.o %OUT%\collision_dispatch.o %OUT%\main.o %OUT%\render_adapter_sgdk.o %OUT%\ow_room_render.o %OUT%\uw_room_render.o %OUT%\uw_room_blob.o %OUT%\roomrom_hud.o %OUT%\roomrom_sprites.o %OUT%\roomrom_combat.o %OUT%\roomrom_boomerang.o %OUT%\roomrom_arrow.o %OUT%\roomrom_bomb.o %OUT%\roomrom_bg_palette.o %OUT%\roomrom_ow_palette.o %OUT%\roomrom_scene_load.o %OUT%\expanded_bg_chr.o %OUT%\atlas_items_chr_x4.o %OUT%\overworld.o %OUT%\overworld_bg.o %OUT%\dungeons.o %OUT%\underworld_bg.o %OUT%\redux_overworld.o %OUT%\redux_overworld_bg.o %OUT%\redux_uw_bg.o %OUT%\redux_hud_chr.o %OUT%\common.o %OUT%\palettes.o %OUT%\sprites.o"
