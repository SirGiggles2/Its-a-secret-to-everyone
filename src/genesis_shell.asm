...
;==============================================================================
; Zelda translated code — generated by tools/transpile_6502.py --no-stubs
; Bank 7 (fixed bank, $C000-$FFFF on NES) contains IsrReset, IsrNmi, RunGame.
; vasm CWD is src/ (set by build.bat pushd), so path is relative to src/.
;==============================================================================
