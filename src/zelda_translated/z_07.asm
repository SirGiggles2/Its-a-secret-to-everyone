    ...
    xdef    Link_EndMoveAndDraw_Bank1

    xdef    Link_EndMoveAndAnimate_Bank1

    xdef    AnimateItemObject

    xdef    WalkableTiles

    xdef    PlayAreaColumnAddrs
...
SaveSlotToPaletteRowOffset:
    ...
    even
InitMode3_Sub1:
    jmp     c_init_mode3_sub1_z07

PatchAndCueLevelPalettesTransferAndAdvanceSubmode:
    jmp     c_patch_and_cue_level_palettes_transfer
...
UpdateMode3Unfurl:
    jmp     c_update_mode3_unfurl

UpdateMode4and6EnterLeave:
    move.b  ($005A,A4),D0
    beq.s  __far_z_07_0027
    jmp  StepOutside
__far_z_07_0027:
    ...
    move.b  ($0394,A4),D0
    bne.s  __far_z_07_0028
    jmp  GoToNextModeResetGridOffset
__far_z_07_0028:
    cmpi.b  #$08,D0
    bne.s  __far_z_07_0029
    jmp  GoToNextModeResetGridOffset
__far_z_07_0029:
    cmpi.b  #$F8,D0
...
GoToNextModePlayLevelSong:
    jmp     c_go_to_next_mode_play_level_song

GoToNextModeResetGridOffset:
    jmp     c_go_to_next_mode_reset_grid_offset
...
GetCollidableTileStill:
    jmp     c_get_collidable_tile_still

GetCollidingTileMoving:
    jmp     c_get_colliding_tile_moving

GetCollidableTile:
    jmp     c_get_collidable_tile
...
Walker_AltDir_GetRandomObjPerpendicularDir:
    jmp     c_walker_alt_dir_get_random_perpendicular

Walker_AltDir_GetMovingOppositeDir:
    jmp     c_walker_alt_dir_get_opposite

ReverseObjDir:
    jmp     c_reverse_obj_dir

Walker_AltDir_EndLoop:
    jmp     c_walker_alt_dir_end_loop
...
DestroyMonster:
    jmp     c_destroy_monster

SetTypeAndClearObject:
    jmp     c_set_type_and_clear_object

FindEmptyMonsterSlot:
    jmp     c_find_empty_monster_slot

InitTileObjOrItem:
    jmp     c_init_tile_obj_or_item
