...
AnimateDemoPhase1Subphase0:
    jmp     c_animate_demo_p1s0

AnimateDemoPhase1Subphase1:
    jmp     c_animate_demo_p1s1
...
ModeE_SyncCharBoardCursorToIndex:
    jmp     c_mode_e_sync_char_board_cursor
...
ModeE_SetNameCursorSpriteX:
    jmp     c_mode_e_set_name_cursor_sprite_x
...
UpdateModeDSave_Sub2:
    jmp     c_update_mode_d_save_sub2

FetchProfileNameAddress:
    jmp     c_fetch_profile_name_address
