...
Flyer_SetStateAndTurns:
    jmp     c_flyer_set_state_and_turns
...
Jumper_PointBoulderDownward:
    jmp     c_jumper_point_boulder_downward
...
Jumper_ResetVSpeedFrac:
    jmp     c_jumper_reset_vspeed_frac
...
_anon_z04_77:
    ...
    even
InitAquamentus:
    jmp     c_init_aquamentus

InitDigdogger1:
    jmp     c_init_digdogger1

InitDigdogger2:
    jmp     c_init_digdogger2
...
L_Dodongo_DecrementBloatedTimer:
    jmp     c_dodongo_dec_bloated_timer
...
UpdateDodongoState1_Bloated_Sub_End:
    jmp     c_update_dodongo_bloated_sub_end
...
Manhandla_SetAllSegmentsDirection:
    jmp     c_manhandla_set_all_segments_direction
...
Ganon_RandomizeLocation:
    jmp     c_ganon_randomize_location
...
ExtractHitPointValue:
    jmp     c_extract_hit_point_value

PlayBossDeathCry:
    jmp     c_play_boss_death_cry
...
_anon_z04_169:
    ...
    even
SetUpFairyObject:
    jmp     c_set_up_fairy_object

ResetFlyerState:
    jmp     c_reset_flyer_state
