...
-- bizhawk_T37_cave_gen_capture.lua for byte-parity comparison by
-- tools/compare_T37_cave_parity.py.
--
-- Outputs:
--   builds/reports/t37_sword_nes_capture.txt
--   builds/reports/t37_sword_nes_capture.json
--   builds/reports/t37_sword_nes_capture.png
...
local OUT_TXT  = repo_path("builds\\reports\\t37_sword_nes_capture.txt")
local OUT_JSON = repo_path("builds\\reports\\t37_sword_nes_capture.json")
local OUT_PNG  = repo_path("builds\\reports\\t37_sword_nes_capture.png")

-- T39 render-classification: NES reference screenshots matching Gen shots.
local T39_SHOTS = {
    { t = 40,  png = repo_path("builds\\reports\\t37_nes_pre.png") },
    { t = 400, png = repo_path("builds\\reports\\t37_nes_incave.png") },
    { t = 600, png = repo_path("builds\\reports\\t37_nes_pickup.png") },
    { t = 900, png = repo_path("builds\\reports\\t37_nes_post.png") },
}
local t39_done = {}
...
-- T37: inventory array at $0657. Slot 0 = sword level (0=none, 1=wood, 2=white, 3=magic).
...
-- ---------------------------------------------------------------------------
local NES_BP_LOG = repo_path("builds\\reports\\T37_cave_nes_statewrite.txt")
local nbp_lines = {}
local nbp_count = 0
local NBP_MAX = 4000
...
for frame = 1, MAX_FRAMES do
    ...
    elseif flow_state == FLOW_T37_CAPTURE then
        ...
        CAPTURE.trace[#CAPTURE.trace + 1] = {
            ...
            movedir = ram_u8(ADDR_MOVEDIR),
            facedir = ram_u8(ADDR_FACEDIR),
            inv_sword = ram_u8(ADDR_INV_SWORD),  -- T37: sword inventory slot
            cavetype = ram_u8(ADDR_CAVETYPE),    -- T37: cave-person spawn template
        }
    end
...
local verdict = (trace_len == SCENARIO.SCENARIO_LENGTH) and "T37_NES_CAPTURE: OK" or "T37_NES_CAPTURE: FAIL"
record(verdict)
write_file(OUT_TXT, table.concat(lines, "\n") .. "\n")
