...
set "LUA=%ROOT%\tools\bizhawk_phase3_room_fidelity_probe.lua"
set "REPORT_DIR=%ROOT%\builds\reports"
set "JSON_REPORT=%REPORT_DIR%\bizhawk_phase3_room_fidelity_probe.json"
set "TEXT_REPORT=%REPORT_DIR%\bizhawk_phase3_room_fidelity.txt"
...
%PYTHON_CMD% "%ROOT%\tools\check_room_fidelity.py"
