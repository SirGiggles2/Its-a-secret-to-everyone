...
set "LUA=%ROOT%\tools\bizhawk_phase3_cave_room7C_probe.lua"
set "REPORT_DIR=%ROOT%\builds\reports"
set "REPORT=%REPORT_DIR%\bizhawk_phase3_cave_room7C_probe.txt"
...
if exist "%REPORT%" (
    ...
    echo.
    echo Phase 3 cave room7C probe report was not generated.
)
