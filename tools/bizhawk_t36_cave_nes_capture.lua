-- bizhawk_t36_cave_nes_capture.lua
...
-- bizhawk_t36_cave_gen_capture.lua for byte-parity comparison by
-- tools/compare_t36_cave_parity.py.
--
-- Outputs:
--   builds/reports/t36_cave_nes_capture.txt
--   builds/reports/t36_cave_nes_capture.json
--   builds/reports/t36_cave_nes_capture.png
...
local OUT_TXT  = repo_path("builds\\reports\\t36_cave_nes_capture.txt")
...
local verdict = (trace_len == SCENARIO.SCENARIO_LENGTH) and "T36_NES_CAPTURE: OK" or "T36_NES_CAPTURE: FAIL"
record(verdict)
write_file(OUT_TXT, table.concat(lines, "\n") .. "\n")
