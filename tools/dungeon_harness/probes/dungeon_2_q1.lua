...
local LABEL = "L2Q1 Moon"
local LEVEL = 2
local QUEST = 1
local SAVE_STATE_PATH = "L2Q1.State"
local EXPECTED_ROOM   = 0x7D  -- expected NES RoomId at entry
local EXPECTED_LEVEL  = 2     -- expected NES CurLevel at entry
