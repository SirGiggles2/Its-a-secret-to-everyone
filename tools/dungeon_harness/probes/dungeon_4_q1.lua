...
local LABEL = "L4Q1 Snake"
local LEVEL = 4
local QUEST = 1
local SAVE_STATE_PATH = "L4Q1.State"
local EXPECTED_ROOM   = 0x67  -- expected NES RoomId at entry
local EXPECTED_LEVEL  = 4     -- expected NES CurLevel at entry
