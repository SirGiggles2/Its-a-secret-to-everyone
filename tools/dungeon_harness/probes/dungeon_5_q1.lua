...
local LABEL = "L5Q1 Lizard"
local LEVEL = 5
local QUEST = 1
local SAVE_STATE_PATH = "L5Q1.State"
local EXPECTED_ROOM   = 0x4B  -- expected NES RoomId at entry
local EXPECTED_LEVEL  = 5     -- expected NES CurLevel at entry
