...
local LABEL = "L1Q1 Eagle"
local LEVEL = 1
local QUEST = 1
local SAVE_STATE_PATH = "L1Q1.State"
local EXPECTED_ROOM   = 0x73  -- expected NES RoomId at entry
local EXPECTED_LEVEL  = 1     -- expected NES CurLevel at entry
