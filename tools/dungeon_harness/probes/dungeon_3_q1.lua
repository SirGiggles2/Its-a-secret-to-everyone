...
local LABEL = "L3Q1 Manji"
local LEVEL = 3
local QUEST = 1
local SAVE_STATE_PATH = "L3Q1.State"
local EXPECTED_ROOM   = 0x23  -- expected NES RoomId at entry
local EXPECTED_LEVEL  = 3     -- expected NES CurLevel at entry
