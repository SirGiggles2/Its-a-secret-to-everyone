...
local LABEL = "L9Q1 Death Mtn"
local LEVEL = 9
local QUEST = 1
local SAVE_STATE_PATH = "L9Q1.State"
local EXPECTED_ROOM   = 0x42  -- expected NES RoomId at entry
local EXPECTED_LEVEL  = 9     -- expected NES CurLevel at entry
