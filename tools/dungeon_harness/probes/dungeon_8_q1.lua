...
local LABEL = "L8Q1 Lion"
local LEVEL = 8
local QUEST = 1
local SAVE_STATE_PATH = "L8Q1.State"
local EXPECTED_ROOM   = 0x60  -- expected NES RoomId at entry
local EXPECTED_LEVEL  = 8     -- expected NES CurLevel at entry
