...
local LABEL = "L6Q1 Dragon"
local LEVEL = 6
local QUEST = 1
local SAVE_STATE_PATH = "L6Q1.State"
local EXPECTED_ROOM   = 0x4F  -- expected NES RoomId at entry
local EXPECTED_LEVEL  = 6     -- expected NES CurLevel at entry
