...
set "LUA=%ROOT%\tools\bizhawk_phase4_movement_probe.lua"
set "REPORT_DIR=%ROOT%\builds\reports"
set "REPORT=%REPORT_DIR%\bizhawk_phase4_movement_probe.txt"
...
if exist "%REPORT%" (
    ...
    echo.
    echo Phase 4 movement probe report was not generated.
)
