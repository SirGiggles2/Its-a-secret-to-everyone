;==============================================================================
; intro_demo/boot.asm — standalone Genesis ROM boot
;
; Boots, inits VDP for H32x V32 plane, sets up stack, jumps to C main().
; No NES emulation, no shell. Pure Genesis.
;==============================================================================
...
;==============================================================================
    ...
    dc.b    "INTRO DEMO                      "  ; domestic name
    dc.b    "                "                  ; pad
    dc.b    "INTRO DEMO                      "  ; overseas name
    dc.b    "                "                  ; pad
...
.z80wait:
    ...
    move.w  #$8004,(VDP_CTRL).l   ; Reg  0: colorfix bit2=1
    move.w  #$8134,(VDP_CTRL).l   ; Reg  1: display OFF, VBlank IRQ on, M5
    ...
    move.w  #$8600,(VDP_CTRL).l   ; Reg  6
    move.w  #$8700,(VDP_CTRL).l   ; Reg  7: BG color = palette 0, color 0
    move.w  #$8800,(VDP_CTRL).l   ; Reg  8
    move.w  #$8900,(VDP_CTRL).l   ; Reg  9
    move.w  #$8AFF,(VDP_CTRL).l   ; Reg 10: H-int counter = $FF (off)
    ...
    move.w  #$8E00,(VDP_CTRL).l   ; Reg 14
    move.w  #$8F02,(VDP_CTRL).l   ; Reg 15: auto-inc = 2
    move.w  #$9000,(VDP_CTRL).l   ; Reg 16: plane size H32 x V32
    move.w  #$9100,(VDP_CTRL).l   ; Reg 17: window H = 0
    move.w  #$9200,(VDP_CTRL).l   ; Reg 18: window V = 0 (window off)
...
;------------------------------------------------------------------------------
; DefaultException — RTE for any unwired exception/interrupt
;------------------------------------------------------------------------------
DefaultException:
    rte
