...
set "LUA=%ROOT%\tools\bizhawk_phase3_up_navigation_probe.lua"
set "REPORT_DIR=%ROOT%\builds\reports"
set "REPORT=%REPORT_DIR%\bizhawk_phase3_up_navigation_probe.txt"
...
if exist "%REPORT%" (
    ...
    echo.
    echo Phase 3 up navigation probe report was not generated.
)
