...
- Define `tools/state/verify_no_alias_collisions.py` interface and failure format. Owned by Phase 2 Task 2.0.
- Inventory existing `RAM(` / `OBJ(` callsites and bucket by subsystem. Owned by Phase 2 Task 2.0.
